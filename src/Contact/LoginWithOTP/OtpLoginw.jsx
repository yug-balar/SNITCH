    ...
    return (
        <section className='bg-emerald-500 flex items-center justify-center h-screen'>
            <div>
                ...
                {
                    user ? (<h2 className='text-center leading-normal text-white font-medium text-3xl mb-6'>
                        👍🏻Login Success
                    </h2>
                    ) : (
                            ...
                            <h1 className='text-center leading-normal text-white font-medium text-3xl mb-6'>Welcome to <br /> Code a Program</h1>
                            {
                                showOTP ?
                                    ...
                                    (<>
                                        ...
                                        <button onClick={onOTPVerify} className='bg-emerald-600 w-full flex items-center justify-center py-2.5 text-white rounded'>
                                            {
                                    ...
                                    (<>
                                        ...
                                        <button onClick={onSignup} className='bg-emerald-600 w-full flex items-center justify-center py-2.5 text-white rounded'>
                                            {
                                                loading && <CgSpinner size={20} className='mt-1 animate-spin' />
                                            }
